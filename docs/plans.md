...
- Last verified: pending current UX pass

## Milestones
- `[in-progress]` Milestone 1: reset durable memory and UX direction
...
- `[pending]` Milestone 2: hosted site UX foundation
...
- `[pending]` Milestone 3: local browser Web UI polish
...
- `[pending]` Milestone 4: CLI UX polish
...
- `[pending]` Milestone 5: verification
...
## Active Notes
- Current branch: `refactor/remove-tui`.
